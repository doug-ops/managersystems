            ...
            IF(IFNULL(_id,0) > 0) THEN
				BEGIN
					...
					UPDATE cashier_closing_company_launch SET 
                           ...
                           inactive = _inactive,
                           config_transfer = _config_transfer
					WHERE
						id = _id;           
			...
			ELSE 
				BEGIN
                    ...
                    (cashier_closing_id, cashier_closing_status, user_operator, company_id, bank_account_id, provider_id, financial_group_id, financial_sub_group_id,
					 ...
					 user_change, change_date, launch_user, launch_date, inactive, config_transfer)
					SELECT 
					...
					_user_change, _processing_date_time, _user_change, _processing_date_time, _inactive, _config_transfer;
                END;
			END IF;
