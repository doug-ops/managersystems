			...
			IF (IFNULL(_exists_compnay,0)=0) THEN
				BEGIN /** Not exists company */
                    ...
                    ELSE 
                        ...
                        END;
					END IF; 
					CALL pr_maintenance_person(1, _next_company_id, _next_company_id, 0, _company_description, _company_description, 'COM', 'J', null, null, null, '', null, 'A', '', '', '', '', null, null, 1058, null, 0, _change_user, now(), null, null, now(), now(), 0, 0, 0, 0, 0, '', null, 0, now(), 0, null, 0, 0, 0, 0);
