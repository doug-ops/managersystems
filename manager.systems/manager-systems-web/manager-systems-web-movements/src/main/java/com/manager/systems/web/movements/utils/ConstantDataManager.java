...
public final class ConstantDataManager 
{
	...
	public static final String PARAMETER_USER_CHIDRENS_PARENT_FUNC = "userChidrensParentFunc";
	public static final String PARAMETER_USER_CHIDRENS_PARENT_CLIENT = "userChidrensParentClient";
	public static final String PARAMETER_USER_CHIDRENS_PARENT_COMBOBOX = "userChildrensParentCombobox";	
	public static final String PARAMETER_USER_CHIDRENS_PARENT_FUNC_COMBOBOX = "userChildrensParentFuncCombobox";	
	public static final String PARAMETER_USER_CHIDRENS_PARENT_CLIENT_COMBOBOX = "userChildrensParentClientCombobox";	
