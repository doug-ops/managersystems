...
public final class ConstantDataManager {
	...
	//21/09/2024
	//Dashboard Company Transfer Closing
	public static final String DASHBOARD_COMPANY_BANK_BALANCE_EXCESS_MOVEMENT_CONTROLLER = "/dashboardCompanyBankBalanceExcessMovement";
	public static final String DASHBOARD_COMPANY_BANK_BALANCE_EXCESS_MOVEMENT_FILTER = "/filter";
	
	//23/10/2024
	//Dashboard Discard Moviment Pending Processing
	public static final String DASHBOARD_FILTER = "/filter";
	public static final String DASHBOARD_DISCARD_MOVEMENT_PENDING_PROCESSING_CONTROLLER = "/dashboardDiscardMovimentPendingProcessing";
	public static final String COMMON_CONTROLLER_DISCARD_MOVEMENT_METHOD = "/discardMovement";
